...
(
    ...
    appointment_type      ENUM ('CONSULTATION', 'FOLLOW_UP', 'EMERGENCY', 'SURGERY', 'DIAGNOSTIC') DEFAULT 'CONSULTATION',
...
(
    ...
    payment_method     ENUM ('CASH', 'CARD', 'INSURANCE', 'BANK_TRANSFER', 'MOBILE_PAYMENT')    DEFAULT 'CASH',
...
(
    ...
    payment_method   ENUM ('CASH', 'CARD', 'INSURANCE', 'BANK_TRANSFER', 'MOBILE_PAYMENT') NOT NULL,
